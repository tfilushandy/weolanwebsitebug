            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group" role="group">
                    ...
                    @csrf()
                      ...
                      <button class="btn btn-outline btn-sm" style="background-color:#3399ff; color: white;"> 
                      -
                      </button>
                    </form>
                ...
                <form action="{{ route('cartdetail.destroy', $detail->id) }}" method="post" style="display:inline;">
                  @csrf
                  {{ method_field('delete') }}
                  <button type="submit" class="btn btn-outline mb-2" style="background-color:#3399ff; color: white;">
                    Hapus
                  </button>
                </form>
                </td>
    ...
    <div class="col col-md-4">
      <div class="card">
        ...
        <div class="card-footer">
          <div class="row">
            <div class="col">
            <a href="{{ URL::to('checkout') }}" class="btn btn-outline" style="background-color:#3399ff; color: white;">Checkout</a>
            </div>
            <div class="col">
              <form action="{{ url('kosongkan').'/'.$itemcart->id }}" method="post">
                @method('patch')
                @csrf()
                <button type="submit" class="btn btn btn-outline" style="margin-left:40px; background-color:#3399ff; color: white;">Kosongkan</button>
              </form>
            </div>
          </div>
        </div>
